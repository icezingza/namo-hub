...
### ENFORCEMENT AND VALIDATION (การบังคับใช้และการตรวจสอบ)
- บังคับใช้การตรวจสคีมาสำหรับผลลัพธ์ที่สร้างขึ้น
- ปฏิเสธผลลัพธ์ที่ขาดส่วนสำคัญ พร้อมบันทึกเหตุผล
- รันทดสอบ unit และ golden tests ก่อนปล่อยหรือดีพลอย
